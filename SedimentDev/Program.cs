...
namespace SedimentDev {
	class Program {
		static void Main(string[] args) {
			...
			var result = System.Text.RegularExpressions.Regex.Replace(System.IO.File.ReadAllText(@"D:\My Stuff\Projects\visual studio 2013\Projects\Sediment\SedimentDev\GenerateBlocksClass\Template.xml"), @"0x[A-F0-9]{1,4}", m => {
